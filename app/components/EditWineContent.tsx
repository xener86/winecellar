...
export default function EditWineContent() {
  ...
  // Nous devons le faire après avoir déclaré tous les hooks.
  ...
  // Si on est côté serveur ou que le client n'est pas encore initialisé, on affiche rien
  if (!isClient) {
    return null;
  }
