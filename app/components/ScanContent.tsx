...
export default function ScanContent() {
  ...
  const positionId = searchParams ? searchParams.get('position') : null;
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && positionId) {
  ...
  if (typeof window === 'undefined') {
    return null; // Ne rien rendre pendant le prérendu côté serveur
  }
