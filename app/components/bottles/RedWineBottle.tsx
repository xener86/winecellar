...
const RedWineBottle = ({ wineInfo }: { wineInfo: WineInfo }) => {
  ...
  return (
    <svg width="100%" height="100%" viewBox="0 0 200 400" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="68" y="183" width="64" height="84" rx="2" stroke="#8B0000" strokeWidth="1" fill="none" />
      
      {/* Contenu de l'étiquette */}
      <text x="100" y="203" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#8B0000" fontFamily="serif">
        {domain || appellation || ""}
      </text>
      ...
      <circle cx="100" y="150" r="15" fill="#8B0000" />
