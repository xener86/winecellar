...
const RoseWineBottle = ({ wineInfo }: { wineInfo: WineInfo }) => {
  ...
  return (
    <svg width="100%" height="100%" viewBox="0 0 200 400" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="65" y="180" width="70" height="90" rx="3" fill="#FFF2F2" />
      
      {/* Bordure décorative de l'étiquette */}
      <rect x="68" y="183" width="64" height="84" rx="2" stroke="#E75A7C" strokeWidth="1" fill="none" />
      
      {/* Contenu de l'étiquette */}
      <text x="100" y="203" textAnchor="middle" fontSize="10" fontWeight="bold" fill="#E75A7C" fontFamily="serif">
        {domain || appellation || ""}
      </text>
      ...
      {vintage && (
        <text x="100" y="245" textAnchor="middle" fontSize="12" fontWeight="bold" fill="#E75A7C" fontFamily="serif">
          {vintage}
        </text>
      )}
